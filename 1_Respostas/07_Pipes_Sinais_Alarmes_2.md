...
Resposta em `Aula_07/questao_01.c`. Compilado através do comando
`:make questao_01.c` no `vi`.
...
Resposta em `Aula_07/questao_02.c`. Compilado através do comando
`:make questao_02.c` no `vi`.
...
Neste exercício, quem recebe a mensagem via pipe é quem as escreve no terminal.  
Resposta em `Aula_07/questao_03.c`. Compilado através do comando
`:make questao_03.c` no `vi`.
...
Resposta em `Aula_07/questao_04.c`. Compilado através do comando
`:make questao_04.c` no `vi`.
...
Resposta em `Aula_07/questao_05.c`. Compilado através do comando
`:make questao_05.c` no `vi`.