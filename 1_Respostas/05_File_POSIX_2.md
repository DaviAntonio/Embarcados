...
```  
Resposta em `Aula_05/cat_falsificado.c`. Binário obtido por `make -f  Makefile-q06`.
...
```  
Resposta em `Aula_05/busca_e_conta.c`. Binário obtido por `make -f Makefile-q07`.